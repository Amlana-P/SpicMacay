...
?>
   ...
   <div id="about" class="container">
                <h1 class="one" style="grid-area: head">About Us</h1>
                <p style="grid-area:about1;" class=" text-justify">
        ...
        SPIC MACAY makes a conscious effort to influence our lives by making us imbibe the simplicity, grace and beauty of our culture and heritage thereby leading a meaningful and enhanced life.</p>
        
        <div  style="grid-area:about2;" ><p  id="listpara"class=" text-justify">Since the Inception……to the present
        ...
        <li>VIRASAT- This is a festival showcasing folk and classical arts, literature, art and crafts, talks, theatre, films and yoga. </li>
        <li>LECTURE DEMONSTRATION - In this format, artists elaborate the intricacies of the art format while performing led by an elaborate question-answer session.</li> 
        <li>WORKSHOP DEMONSTRATION - The audience is taught a short piece of art firm before performance.</li></ul> </p></div>
        
        <p style="grid-area:about3;" class=" text-justify">Our Gems…
        ...
        In this world of superficiality where everyone is projecting themselves to be much more important than one's development within. This often results in leading a materialistic and shallow life unescorted by an inner connect of our roots. SPIC MACAY makes a conscious effort to keep us rooted to our culture thereby promoting us to lead burgeoning life and also safeguarding our ethnic diversity.</p> 

               <img src="img/inno1.jpg" class="sideimg" style="grid-area: img4">
               <img src="img/inno2.jpg" class="sideimg" style="grid-area: img2">
               <img src="img/inno3.jpg" class="sideimg" style="grid-area: img3">
               <img src="img/inno4.jpg" class="sideimg" style="grid-area: img1">
